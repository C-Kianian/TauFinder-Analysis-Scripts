#taken from https://github.com/ethanmar/MuColl-TauStudy, only addition is the final method to count pi0s
...
# Get number of reco charged pions (only difference between https://github.com/ethanmar/MuColl-TauStudy)
def getNRecoNeutralPis(recoTau):

    # Initialize variable to keep track of number of reco photons or psuedo pi0s
    nRecoPi0s = 0
